 ...
 * Generated at: 2021-09-16 15:52:23 UTC
...
if(cityId!=0 && city.getCityId()==cityId){ 
      ...
      out.write("        <div class=\"container box   pl-5 mb-5\">\r\n");
      ...
      out.write("                </select>\r\n");
      out.write("                 <input type=\"search\" class=\"form-control w-75 \" id=\"srh_field\" style=\"height: 45px;\" placeholder=\"Search doctors, hospitals, medicines\">\r\n");
      out.write("                <input type=\"submit\" value=\"Search\" id=\"srch_btn\" class=\"btn btn-info ml-1\" style=\"height: 45px;\">\r\n");
      out.write("            </form>\r\n");
      out.write("            \r\n");
      out.write("            <div class=\"container mt-1 w-75 text-info \" style=\"display:none;\" id=\"doctor_srch_func\">\r\n");
      out.write("\t\t     \t<div class=\"rows p-2\">\r\n");
 ...
 ArrayList<Hospital> hospitals = Hospital.getHospitalNames();  
      out.write(" \r\n");
      out.write("\t\t     \t\t\t\t \r\n");
      out.write("\t\t     \t\t\t\t\t<select class=\"form-control btn btn-info border border-info  \"   id=\"id_hospital\" name=\"hospital\">\r\n");
 ...
 ArrayList<String> specialities = Doctor.getDoctorSpeciality();  
      out.write("\r\n");
      out.write("\t\t     \t\t\t\t\t \r\n");
      out.write("\t\t     \t\t\t\t\t<select class=\"form-control ml-4 border border-info btn btn-info\" id=\"id_speciality\"   name=\"speciality\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='0'>Select speciality</option>\r\n");
      out.write("\t\t     \t\t\t\t\t\t");
 for(int i=0;i<specialities.size();i++){ 
      out.write("\r\n");
      out.write("\t\t     \t\t\t\t\t\t\t<option value='");
      out.print(specialities.get(i)  );
      out.write('\'');
      out.write(' ');
      out.write('>');
      out.print( specialities.get(i) );
      ...
      out.write("\t\t     \t\t\t\t\t</select>\r\n");
      out.write("\t\t     \t\t\t\t\t\r\n");
      out.write("\t\t     \t\t\t\t\t<select class=\"form-control ml-4 border border-info btn btn-info \" id=\"id_timing\"    name=\"timing\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='0'>Select Timing</option>\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='1'>10AM-12PM</option>\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='2'>12PM-02PM</option>\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='3'>2PM-04PM</option>\r\n");
      out.write("\t\t     \t\t\t\t\t\t<option value='4'>4PM-6PM</option>\r\n");
      out.write("\t\t     \t\t\t\t\t</select>  \r\n");
      out.write("\t\t     \t\t\t\t\t \r\n");
      out.write("\t\t     \t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t</form>\r\n");
