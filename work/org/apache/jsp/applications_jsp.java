 ...
 * Generated at: 2021-08-21 04:11:18 UTC
...
public final class applications_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("models.Application");
...
if(cityId!=0 && city.getCityId()==cityId){ 
      ...
      out.write("                   <a href=\"register_opt.jsp\">Doctor Applications  </a> <span class=\"text-white\">></span>\r\n");
      out.write("                   \r\n");
      out.write("               </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("     \t\t\t<h3 class=\"border-bottom border-info text-info pt-3 pb-2 pl-2\">Doctor Applications  </h3>\r\n");
      out.write("     \t\t</div>\r\n");
      out.write("     \t</div>\r\n");
      out.write("     </div>\r\n");
      out.write("     \r\n");
...
for(int i=0;i<list.size();i++){  
      ...
      out.write("   \t\t\t\t\t<tbody>\r\n");
      out.write("   \t\t\t\t\t\t<tr id=\"id_");
      out.print(list.get(i).getApplicationId() );
      out.write("\">\r\n");
      out.write("   \t\t\t\t\t\t\t<td class=\"s_no\">");
      out.print( i+1 );
      out.write(" </td>\r\n");
      out.write("   \t\t\t\t\t\t\t<td>");
      out.print( list.get(i).getDoctor().getName() );
      out.write(" </td>\r\n");
      out.write("   \t\t\t\t\t\t\t<td><a href=\"showDoctorLicense.do?fileName=");
      out.print( list.get(i).getDoctorLicenseFile());
      out.write("\">Download File</a></td>\r\n");
      out.write("   \t\t\t\t\t\t\t<td><input type=\"button\" value=\"Show\" id=\"id_show_");
      out.print(list.get(i).getDoctor().getDoctorId() );
      out.write("\" class=\"btn btn-info show_btn\"></td>\r\n");
      out.write("   \t\t\t\t\t\t\t<td>\r\n");
      out.write("    \t\t\t\t\t\t\t<input type=\"button\" value=\"Accept\" class=\"btn btn-info accept_btn\" id=\"accept_");
      out.print(list.get(i).getApplicationId() );
      out.write("\">\r\n");
      out.write("    \t\t\t\t\t\t\t<input type=\"button\" value=\"Reject\" class=\"btn btn-info reject_btn\" id=\"reject_");
      out.print(list.get(i).getApplicationId() );
      out.write("\">\r\n");
      out.write("    \t\t\t\t\t\t\t<span id=\"id_");
      out.print( list.get(i).getHospital().getHospitalId() );
      out.write("\" class=\"hospital_id\"></span>\r\n");
      out.write("    \t\t\t\t\t\t\t<span id=\"id_");
      out.print(list.get(i).getDoctor().getDoctorId() );
      out.write("\" class=\"appId_");
      out.print(list.get(i).getApplicationId() );
      out.write("\"></span>\r\n");
      out.write("   \t\t\t\t\t\t\t</td>\r\n");
      out.write("   \t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("     \t\t\t\t \r\n");
      out.write("     \t\t\t\t<i class=\"fa fa-times fa-lg float-right mt-3\" style=\"cursor:pointer\"></i>\r\n");
      out.write("     \t\t\t\t<div class=\"container  border-bottom border-info text-info mb-4 mt-3 \">\r\n");
      out.write("\t\t\t\t     \t<div class=\"rows px-3 pb-2 pt-1 \">\r\n");
      out.write("\t\t\t\t     \t\t<div class=\"cols \">\r\n");
      out.write("\t\t\t\t     \t\t\t<h3 id=\"heading\">Doctor Profile</h3>\r\n");
      out.write("\t\t\t\t     \t\t</div>\r\n");
      out.write("\t\t\t\t     \t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("     \t\t\t\t<div id=\"doctor_profile_div\" >\r\n");
      out.write("\t     \t\t\t\t\r\n");
      out.write("\t \t\t\t\t\t<form class=\"doctor_form\" id=\"profile_form\">\r\n");
      ...
      out.write("\t\t     \t\t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<label for=\"id_doctor_id\">Doctor Id:</label>\r\n");
      out.write("\t\t\t     \t\t\t\t\t<input type=\"text\" class=\"form-control form_inp\" name=\"doctor_id\" id=\"id_doctor_id\">     \t\t\t\t\t \r\n");
      out.write("\t\t\t                         \r\n");
      out.write("\t\t     \t\t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t \r\n");
      ...
      out.write("\t\t     \t\t\t\t<div class=\"row mb-2\">\r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<label for=\"gender\" class=\"d-block mt-1\">Gender:</label>\r\n");
      out.write("\t\t\t     \t\t\t\t\t<input type=\"text\" class=\"form-control form_inp\" name=\"gender\" id=\"id_gender\"> \r\n");
      out.write("\t\t     \t\t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
...
if(hospital!=null&&city.getCityId()==hospital.getCity().getCityId()){ 
      ...
      out.write("\t\t\t     \t\t\t\t\t<input type=\"text\" class=\"form-control form_inp\" name=\"specialization\" id=\"id_specialization\">     \t\t\t                         \r\n");
      out.write("\t\t     \t\t\t\t\t</div> \r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<label for=\"id_experience\">Experience:</label>\r\n");
      out.write("\t\t\t     \t\t\t\t\t<input type=\"text\" class=\"form-control form_inp\" name=\"experience\"  id=\"id_experience\" >     \t\t\t\t\t      \r\n");
      out.write("\t\t     \t\t\t\t\t</div>     \t\t\t\t\t \r\n");
      out.write("\t\t     \t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t<div class=\"row mb-2\">\r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
      out.write("\t\t     \t\t\t\t\t\t<label for=\"id_service_time\">Service Time:</label>\r\n");
      out.write("\t\t                  \t\t\t<input type=\"text\" class=\"form-control form_inp\" name=\"service_time\"  id=\"id_service_time\" > \r\n");
      out.write("\t\t     \t\t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t</div>\r\n");
      out.write("\t\t     \t\t\t\t<div class=\"row mb-2\">\r\n");
      out.write("\t\t     \t\t\t\t\t<div class=\"col\">\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("    <script type=\"text/javascript\" src='static/js/applications.js'></script>\r\n");
      out.write("     \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
