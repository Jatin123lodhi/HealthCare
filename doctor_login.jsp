        ...
        <div class="container ">
            <div class="row">
               <div class="col py-2">
                ...
                <a href=""> Doctor Login </a> <span class="text-white">></span>
        ...
        <div class="container   " style="min-height: 500px;">
            <div class="row pt-4 ">
                ...
                <div class="col-6 pt-2 pl-5   ">
                    ...
                    <form action="doctor_login.do" method="post" class="p-4 " id="login_form">
                        ...
                        <div class="form-group">
                            ...
                            <small id="password_help" class="form-text text-muted">Password must  be alteast 4 characters long</small>
