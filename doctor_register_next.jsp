        ...
        <div class="container  " style="min-height: 500px;">
            <div class="row pt-4 ">
                <div class="col-6 pt-5 text-center"  >
                    ...
                    <img src="static/images/doctor2.png" alt="" style="width: 50%;" class=" pt-5 ">
                </div>
                <div class="col-6  pt-5 pl-5 ">
                  
                  <h3>Registered Successfully</h3>
     				<h5 class="mt-3 mb-5">Activate the account using the activation link sent to your mail</h5>
					<h6 class="mt-3 text-muted p-2">Mail not received ? Register again using the <a href="doctor_register.jsp">link.</a></h6>
                </div>
            </div>
        </div>
    </div>
