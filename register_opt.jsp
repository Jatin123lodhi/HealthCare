...
<body>
    ...
    <div class="main_body">
        <h3 class="text-secondary text-center pt-3">Register as -</h3>
        ...
        <div class="container" style="height: 470px;">
            ...
            <div class="row text-center  mt-3">
                <div class="col-4 ">
                    <a href="hospital_register.do" class="btn btn-info">Hospital</a>
                </div>
                <div class="col-4">
                    <a href="doctor_register.do" class="btn btn-info">Doctor</a>
                </div>
                <div class="col-4">
                    <a href="patient_register.do" class="btn btn-info">Patient</a>
                </div>
            </div>
        </div>
    </div>
